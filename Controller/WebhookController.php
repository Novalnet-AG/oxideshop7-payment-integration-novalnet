...
class WebhookController extends FrontendController
{
    ...
    protected function getOrderReference()
    {
        ...
        } elseif (!empty($this->eventData['custom']['inputval2']) || !empty($this->eventData['custom']['oxid_Id'])) {
            $orderID = !empty($this->eventData['custom']['inputval2']) ? $this->eventData['custom']['inputval2'] : $this->eventData['custom']['oxid_Id'];
            $aResult = NovalnetUtil::getTableValues('OXPAYMENTTYPE, OXLANG', 'oxorder', 'OXID', $orderID);

    ...
    public function render()
    {
        ...
        if (!empty($sOxId)) {
            ...
            if (preg_match("/novalnet/i", $oOrder->oxorder__oxpaymenttype->value)) {
                ...
                if (!empty($aTransDetails) && $oOrder->oxorder__oxpaymenttype->value != 'novalnetpayment' && !preg_match("/novalnet_/i", $oOrder->oxorder__oxpaymenttype->value)) {
            ...
            return "@novalnetpayment/backend/novalnet_order.html.twig";
        }
    }

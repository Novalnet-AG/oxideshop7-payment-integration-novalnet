...
namespace Novalnet\Payment\Controller;
...
class AccountOrderController extends AccountOrderController_parent
{
    ...
    public function getNovalnetPayment($iOrderNo, $sPaymentMethod)
    {
        ...
        if (!empty($aNovalnetOrder) && $sPaymentMethod != 'novalnetpayment' && !preg_match("/novalnet_/i", $sPaymentMethod)) {
        ...
        } elseif ($sPaymentMethod == 'novalnetpayment') {
            return $aNovalnetOrder['PAYMENT_TYPE'];
        }
    }
